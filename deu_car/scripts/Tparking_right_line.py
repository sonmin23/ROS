...
class DetectRightLineTparking:
    ...
    def image_callback(self, msg):
        ...
        try:
            ...
            pass
            # rospy.loginfo('Unregister image_sub')
        # elif self.state == 2:
        #     self.image_sub.unregister()
        #     rospy.loginfo("state 2")
        #
        # elif self.state_after == 2:
        #     print('>>>>', self.state_after)
        #     if len(contours) > 0:
        #         self.robot_controller.set_angle(angle)
        #         self.robot_controller.set_velocity(1.0)
        ...
        #         self.robot_controller.go_forward()
            ...
            if len(contours) > 0:
                ...
                self.robot_controller.set_angle(-0.75)
                self.robot_controller.set_velocity(0.5)
                self.robot_controller.go_forward()
        ...
        #         self.robot_controller.set_velocity(0.5)
        #     else:
        #         self.robot_controller.set_angle(-0.7)
        #         self.robot_controller.set_velocity(0.5)
        #     self.robot_controller.go_forward()
